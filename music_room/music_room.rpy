...
define MUSIC_ROOM_IDLE_COLOR = "#888888"
define MUSIC_ROOM_HOVER_COLOR = "#9b1814"
define MUSIC_ROOM_SELECTED_IDLE_COLOR = "#ffffff"
define MUSIC_ROOM_SELECTED_HOVER_COLOR = "#9b1814"
...
screen music_room(mr):
    ...
    frame:
        ...
        viewport:
            ...
            has vbox
            label _("Lista de músicas") style "music_room_title"
...
style music_room_title_text:
    ...
    size 50 color "#cc0000" xalign 0.5
...
style track_list_button:
    right_padding 45
    background Transform("#cc0000", ysize=2, yalign=1.0)
...
style track_list_label_text:
    color "#f7f7ed" hover_color "#9b1814" selected_color "#cc0000"
    insensitive_color "#666"
style track_list_vscrollbar:
    thumb "#cc0000" base_bar "#510000"
        ...
        nearrect:
            ...
            button:
                ...
                vbar value MixerValue(mr.channel) xysize (25, 200):
                    xalign 0.5 top_bar "#510000" thumb None
                    hovered SetScreenVariable('hide_volume', False)
                    bottom_bar "#cc0000"
        if hide_volume:
...
screen music_room3(mr):
    ...
    add HBox(Transform("#29283500", xsize=350), "#3d3d3f14") # Background

    ############################################################################
    ## If you have a standard Ren'Py UI sidebar, you can use this:
    ##
    use extras_menu(_("Sala de musica")):
    ##
            ...
            vbox:
                ...
                hbox:
                    ...
                    bar value MixerValue(mr.channel) xysize (150, 25):
                        xalign 0.5 right_bar "#510000" thumb None yalign 0.5
                        left_bar "#cc0000"
...
style musicroom3_frame:
    ...
    background Frame(
        Fixed(
            Transform("#cc000000", xysize=(100, 100)),
            Transform("#88888800", xysize=(90, 90), align=(0.5, 0.5)),
            xysize=(100, 100)
        ), 10, 10
    )
