...
style choice_button is default:
    ...
    background Frame("gui/button/choice_[choice_button_color]_[prefix_]background.png")
...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Terminar Replay") action EndReplay(confirm=True)
